...
import { View, Text, TouchableWithoutFeedback, TouchableNativeFeedback, Platform } from 'react-native';
            ...
            {routes.map(route => (
                ...
                >
                    <View style={styles.tab}>
                        <Icon name={route.icon} size={iconSize} color={isActive(route, activeRoute) ? activeTextColor : textColor} />
                        <Text style={[styles.text, isActive(route, activeRoute) ? styles.textActive : undefined]}>{route.name}</Text>
                    </View>
                </Touchable>
            ))}
        </View>
