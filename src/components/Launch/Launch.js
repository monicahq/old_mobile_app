...
export const Launch = ({ navigate }) => (
    <SafeAreaView forceInset={{ top: 'always' }} style={{ flex: 1, alignItems: 'center', justifyContent: 'center',  }}>
        ...
        <View style={styles.centeredBlock}>
            ...
            <Text style={styles.primaryText}>Keep track of every interaction with your friend and family!</Text>
            <Text style={styles.secondaryText}>Remember when you last called, what you talked about, the name of their kids or what they prefer to eat!</Text>
